    ...
    <section id="content" class="container clearfix">
        ...
        <ul id="gallery" class="portfolio-grid clearfix">
            ...
            <li data-id="id-8" data-type="photography" class="entry one-fourth">
                <div class="entry-image">
                    <a class="fancybox" href="images/entries/full-size/dining-brown.jpg" title="Project Title"><span class="overlay zoom"></span><img src="images/entries/220x130/dining-brown-220x130.png" alt=""></a>
                </div>
                <h4 class="entry-title"><a href="portfolio-item-image.php">Brown Dining Room</a></h4>
                <div class="entry-content">
                    <p>Image project with lightbox.</p>
                </div>
            </li>
            <li data-id="id-9" data-type="web-design print-design" class="entry one-fourth">
                <div class="entry-image">
                    <a class="fancybox" href="images/entries/full-size/dining-and-living-cream.jpg" title="Project Title"><span class="overlay zoom"></span><img src="images/entries/220x130/dining-and-living-cream-220x130.png" alt=""></a>
                </div>
                <h4 class="entry-title"><a href="portfolio-item-image.php">Cream Dining and Living Room</a></h4>
                <div class="entry-content">
                    <p>Image project with lightbox.</p>
                </div>
            </li>
            <li data-id="id-10" data-type="web-design" class="entry one-fourth">
                <div class="entry-image">
                    <a class="fancybox" href="images/entries/full-size/villa.jpg" title="Project Title"><span class="overlay zoom"></span><img src="images/entries/220x130/villa-220x130.png" alt=""></a>
                </div>
                <h4 class="entry-title"><a href="portfolio-item-image.php">Villa</a></h4>
                <div class="entry-content">
                    <p>Image project with lightbox.</p>
                </div>
            </li>
            <li data-id="id-11" data-type="photography" class="entry one-fourth">
                <div class="entry-image">
                    <a class="fancybox" href="images/entries/full-size/building.jpg" title="Project Title"><span class="overlay zoom"></span><img src="images/entries/220x130/building-220x130.png" alt=""></a>
                </div>
                <h4 class="entry-title"><a href="portfolio-item-image.php">Building</a></h4>
                <div class="entry-content">
                    <p>Image project with lightbox.</p>
                </div>
            </li>
