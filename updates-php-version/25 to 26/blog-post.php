        ...
        <section id="main" class="blog-entry-single three-fourths">
            <article class="entry clearfix">
                <div class="entry-image">
                    <a class="fancybox" href="images/entries/full-size/living-white.jpg" title="Post Title"><span class="overlay zoom"></span><img src="images/entries/700x240/living-white-700x240.png" alt=""></a>
                </div>
                    ...
                    <div class="entry-content">
                        ...
                        <blockquote class="simple">
                            <div class="quote-content">
                                <p>Mauris vitae elementum eros. Donec id nisl vitae tellus consequat volutpat. Phasellus vitae magna eget dolor viverra convallis. Proin dictum sollicitudin dolor, vel imperdiet sapien porta id. Phasellus massa enim, ultrices vel porttitor ut, commodo rhoncus tortor. Etiam at purus libero, quis molestie leo. Cras luctus ligula nec leo dapibus.</p>
                            </div>
            ...
            <section class="related-posts">
                ...
                <ul class="post-carousel" data-scroll="3">
                    <li class="entry">
                        <div class="entry-image">
                            <a href="blog-post.html" title="Post Title"><span class="overlay link"></span><img src="images/entries/220x130/study-220x130.png" alt=""></a>
                        </div>
                        <div class="entry-meta">
                    ...
                    <li class="entry">
                        <div class="entry-slider">
                            <ul>
                                <li><a href="blog-post.html" title="Post Title"><span class="overlay link"></span><img src="images/entries/220x130/dining-white2-220x130.png" alt=""></a></li>
                                <li style="display: none;"><a href="blog-post.html" title="Post Title"><span class="overlay link"></span><img src="images/entries/220x130/dining-brown-220x130.png" alt=""></a></li>
                                <li style="display: none;"><a href="blog-post.html" title="Post Title"><span class="overlay link"></span><img src="images/entries/220x130/dining-white-220x130.png" alt=""></a></li>
                            </ul>
                        </div>
                        <div class="entry-meta">
                                ...
                                <ol class="children">
                                    ...
                                    <li class="comment">
                                        ...
                                        <div id="comment-3" class="comment-wrap">
                                            ...
                                            <div class="comment-details">
                                                <div class="comment-author"><a href="#">admin <span class="post-author">(Author)</span></a></div>
